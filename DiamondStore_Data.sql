...
('P048', 'ETINCELLE CARTIER EARINGS', 'E008', 'ETINCELLE CARTIER EARINGS', 'C004', 130.0, 200.0, 65.0, 1.7, 4, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw6a5d4eda/images/large/2e4d9ce2e418521983a1ac9d6becf3e6.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
...
INSERT INTO Tbl_Product (ProductID, ProductName, ProductCode, Description, CategoryID, MaterialCost, GemCost, ProductionCost, PriceRate, ProductSize, Image, Status)
VALUES
('P061', 'LOVE WEDDING RING', 'R002', 'LOVE WEDDING RING', 'C001', 150.0, 0.0, 75.0, 1.6, 5, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwd402bde3/images/large/509efad81d12569981abebf66c433720.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P062', 'LOVE RING', 'R003', 'LOVE RING', 'C001', 120.0, 0.0, 60.0, 1.5, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwd4e6a50c/images/large/41bb20649b985d5ea6fc0a93c60b78e4.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P063', 'JUSTE UN CLOU RING', 'R004', 'JUSTE UN CLOU RING', 'C001', 180.0, 0.0, 90.0, 1.7, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwf5469b9e/images/large/bf9dfa2bb0c851eabf8bb3bb3b71bb51.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P064', 'CLASSIC TRINITY RING', 'R005', 'CLASSIC TRINITY RING', 'C001', 200.0, 0.0, 100.0, 1.8, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw09ee40f1/images/large/a5b15a29b0ff58b59bd59da81e8df880.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P065', 'C DE CARTIER WEDDING RING', 'R006', 'C DE CARTIER WEDDING RING', 'C001', 160.0, 0.0, 80.0, 1.7, 5, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw892af08e/images/large/90fd2fc2e7755fa2937548e88f432689.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P066', 'PANTHÈRE DE CARTIER RING', 'R007', 'PANTHÈRE DE CARTIER RING', 'C001', 220.0, 0.0, 110.0, 1.9, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw3cd6cdb5/images/large/f4acd110455e5cd6bd59f727faa18167.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P067', '1895 WEDDING RING', 'R008', '1895 WEDDING RING', 'C001', 140.0, 0.0, 70.0, 1.6, 5, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw52a6acef/images/large/eec1cd1a831e59e2a15d84636f6e6e1e.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P068', 'CLASSIC TRINITY CERAMIC RING', 'R009', 'CLASSIC TRINITY CERAMIC RING', 'C001', 180.0, 0.0, 90.0, 1.7, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwea86e359/images/large/db7e25dc70785975b94e8b99ba23ab63.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P069', 'VENDÔME LOUIS CARTIER WEDDING RING', 'R010', 'VENDÔME LOUIS CARTIER WEDDING RING', 'C001', 170.0, 0.0, 85.0, 1.7, 5, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw917abdf8/images/large/17aede18007657958850cb22b84106d9.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P070', 'CLASH DE CARTIER RING', 'R011', 'CLASH DE CARTIER RING', 'C001', 190.0, 0.0, 95.0, 1.8, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwef7c1597/images/large/076f10e21cdb537aaa79b68216507b77.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P071', 'LOVE RING', 'R012', 'LOVE RING', 'C001', 120.0, 0.0, 60.0, 1.5, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw937228b5/images/large/8c37fbe71a4152b0a024219ce53d5dbe.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P072', 'GRAIN DE CAFE RING', 'R013', 'GRAIN DE CAFE RING', 'C001', 180.0, 0.0, 90.0, 1.7, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw49884b63/images/large/1add28981c8551e7802707f446dc2141.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P073', 'PANTHÈRE DE CARTIER RING', 'R014', 'PANTHÈRE DE CARTIER RING', 'C001', 220.0, 0.0, 110.0, 1.9, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwfb029409/images/large/8c78df80514b55b6b814d2abc8e0a1ae.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P074', 'ETINCELLE DE CARTIER RING', 'R015', 'ETINCELLE DE CARTIER RING', 'C001', 130.0, 200.0, 65.0, 1.7, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw49ac0398/images/large/4d6275f9a3f15c92a8633a6146d890b2.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P075', 'LOVE RING', 'R016', 'LOVE RING', 'C001', 120.0, 0.0, 60.0, 1.5, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw73815751/images/large/699f4a8aa8b854398b026fd917ec3bf5.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P076', 'PANTHÈRE DE CARTIER RING', 'R017', 'PANTHÈRE DE CARTIER RING', 'C001', 220.0, 0.0, 110.0, 1.9, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw68becd31/images/large/cd8eec7fd3065f1b992a0e4d295a79e3.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P077', 'REFLECTION DE CARTIER RING', 'R018', 'REFLECTION DE CARTIER RING', 'C001', 190.0, 0.0, 95.0, 1.8, 6, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dwdbc66fa9/images/large/a2524f59983451d18e7a9633cc8b93a5.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
('P078', 'ÉCROU DE CARTIER RING', 'R019', 'ÉCROU DE CARTIER RING', 'C001', 170.0, 0.0, 85.0, 1.7, 7, 'https://www.cartier.com/dw/image/v2/BGTJ_PRD/on/demandware.static/-/Sites-cartier-master/default/dw751eca6f/images/large/2847f0f83bce5684a028226607e825de.png?sw=350&sh=350&sm=fit&sfrm=png', 1),
...
UPDATE Tbl_Customer set DiscountRate = 0.05 where CustomerID = 1
UPDATE Tbl_Customer set DiscountRate = 0.1 where CustomerID = 2
UPDATE Tbl_Customer set DiscountRate = 0.02 where CustomerID = 3
UPDATE Tbl_Customer set DiscountRate = 0.15 where CustomerID = 4
UPDATE Tbl_Customer set DiscountRate = 0.05 where CustomerID = 5

UPDATE Tbl_GemPriceList SET Origin = 'Natural' WHERE ID = 1
UPDATE Tbl_GemPriceList SET Origin = 'Synthetic' WHERE ID = 2
UPDATE Tbl_GemPriceList SET Origin = 'Natural' WHERE ID = 3
UPDATE Tbl_GemPriceList SET Origin = 'Synthetic' WHERE ID = 4
UPDATE Tbl_GemPriceList SET Origin = 'Natural' WHERE ID = 5
